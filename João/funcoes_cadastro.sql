...
CREATE OR REPLACE FUNCTION CADASTRAR_LOJA(
    ...
    L_STATUS_LOJA VARCHAR
) RETURNS VOID AS $$
BEGIN
    EXECUTE format('INSERT INTO %I (NOME_LOJA, ENDERECO, STATUS_LOJA) VALUES ($1, $2, $3)', L_NOME_TABLE)
    USING L_NOME_LOJA, L_ENDERECO_LOJA, L_STATUS_LOJA;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    EXECUTE format('INSERT INTO %I (QUANTIDADE_EST, COD_PROD, COD_LOJA) VALUES ($1, $2, $3)', E_NOME_TABLE)
...
BEGIN
    EXECUTE format('INSERT INTO ITEM_COMPRA (COD_ITEM_COMPRA, COD_COMPRA, COD_ESTOQUE, QTD_ITENS_COMPRA) VALUES ($1, $2, $3, $4)')
    ...
    CASE TABELA_NOME
        ...
        WHEN 'item_venda' THEN
            IF IV_COD_ITEM_VENDA IS NOT NULL AND IV_COD_ESTOQUE IS NOT NULL AND IV_QTD_ITENS_VENDA IS NOT NULL THEN
                PERFORM CADASTRAR_ITEM_VENDA(IV_COD_ITEM_VENDA, IV_COD_ESTOQUE, IV_QTD_ITENS_VENDA);
            END IF;
...
SELECT CADASTRAR_FUNCIONARIO('funcionario', 'Mariana Lima', 1, '1111-2222', 'Ativo');
SELECT CADASTRAR_FUNCIONARIO('funcionario', 'Pedro Oliveira', 1, '3333-4444', 'inativo');
