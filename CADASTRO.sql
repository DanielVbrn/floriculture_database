...
BEGIN
    FOR ITEM IN (SELECT * FROM TEMP_ITEM_VENDA) LOOP
        SELECT COD_ESTOQUE, QUANTIDADE_EST INTO NOVO_COD_ESTOQUE, QUANTIDADE_ATUAL
        FROM ESTOQUE
        ...
        VALUES (NOVO_COD_ITEM_VENDA, NEW.COD_VENDA, NOVO_COD_ESTOQUE, ITEM.QTD_ITENS_VENDA);
...
FOR EACH ROW
EXECUTE FUNCTION CADASTRAR_ITEM_VENDA();
